            ...
            <div class="before_login_pc_body_right">
                <div class="before_login_pc_body_right_body">
                    ...
                    <div class="before_login_pc_body_right_box">
                        {/* {% else %} */}
                        <form action="{% url 'inside_signup' %}" method="POST" class="before_login_pc_body_right_box">
                            {/* {% endif %} {% csrf_token %} */}
                            <div class="before_login_pc_body_right_top">
                                <div class="before_login_pc_body_right_box_header">
                                    {/* {% if back_link %} */}
                                        <a href="{{back_link}}" class="before_login_pc_body_right_box_header_arrow">
                                    {/* {% else %} */}
                                        <a href="{% url 'home' %}" class="before_login_pc_body_right_box_header_arrow">
                                    {/* {% endif %} */}
                                ...
                                <div class="before_login_pc_body_right_business_id_box_middle_form">
                                    ...
                                    <div class="before_login_pc_body_right_business_id_box_middle_form_input">
                                        ...
                                        <span class="input_field">
                                             <input onfocus="checkMediaQuery()" required type="number" name="mobile_number" class="username" placeholder="Phone Number" value="{{mobile_number}}" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" />
                                    </span>
                                    </div>
